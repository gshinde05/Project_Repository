<?php
	...
	include("includes/handlers/add-student-handler.php");
  ...
  <ul>
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="nav-link scrollto" href="#">Add Students</a></li>
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="nav-link scrollto" href="">Add Projects</a></li>
