...
<header id="header" class="d-flex align-items-center">
    ...
    <div class='searchprojectcontainer' style='text-align: center; margin-top: 200px;'>
       <input type="text" id="searchInput" class="searchprojinputs" value="<?php echo $term; ?>" placeholder="Search Project" onfocus="this.value = this.value" style='font-size: 20px; width: 500px; height: 30px;'>
    </div>
            ...
            */
            ...
            $(".searchprojinputs").keyup(function() {
                ...
                timer = setTimeout(function() {
                    ...
                    openPage("search-project.php?term=" + val);
                    /*                    console.log("hi");*/
                }, 2000);
            })
        })
