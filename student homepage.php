...
<section id="topbar" class="d-flex align-items-center">
  ...
  <header id="header" class="d-flex align-items-center">
    ...
    <img src="http://localhost/ProjectRepository/includes/img/RepoLogo.jpeg" height="70" width="280" class="logo"></img>
  ...
  <ul>
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="nav-link scrollto" href="#option1">Option 1</a></li>
        <li><a class="nav-link scrollto" href="#option2">Option 2</a></li>
        <li><a class="nav-link scrollto" href="#option3">Option 3</a></li>
      </ul>
    </li>
    ...
    <li class="dropdown">
      ...
      <ul class="dropdown-menu">
        <li><a class="nav-link scrollto" href="#optionA">Option A</a></li>
        <li><a class="nav-link scrollto" href="#optionB">Option B</a></li>
        <li><a class="nav-link scrollto" href="#optionC">Option C</a></li>
      </ul>
    </li>
  </ul>
</nav><!-- .navbar -->
