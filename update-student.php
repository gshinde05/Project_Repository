...
<header id="header" class="d-flex align-items-center">
  <div class="container d-flex align-items-center justify-content-between">
    ...
    <h1 style="color:white" align="center">Student Details</h1>
    <section>
        <form method="POST" action="">
            ...
            <input type="text" name="date_of_admission" id="date_of_admission" value="<?php echo $date_of_admission; ?>">
        ...
        <select id="status" name="status">
            ...
            <input type="text" name="passout_year" id="passout_year" value="<?php echo $passout_year; ?>">
